...
m_hSvc.create1D("MassZprime_2jets", "; Zprime_2jets Mass (GeV) ; Events", 20, 0, 2000);
 ...
 m_hSvc.create1D("Pt_1Fatj2SjClos", " 1FatJet_2jetsCloseToLep p_{T} (GeV) ; Events", 20, 0, 2000);
                 
  m_hSvc.create1D("PtGStar_1Fatj2SjClosNSeljL", "; GStar p_{T} (2Sjets + 1Fat jets + W) (GeV) ; Events", 40, 0, 4000);

 m_hSvc.create1D("Mass_1Fatj2SjClos", " M(Jet_Fat[0]+SjetsCloseLep[0]+SjetsCloseLep[1]) (GeV)", 36, 0, 3600);
 ...
 m_hSvc.create1D( "Pt_SjClos0", " 1FatJet_2jets: JetCloseLep[0] p_{T} (GeV); Events", 20, 0, 2000);//done old: 20, 0, 2000
 m_hSvc.create1D( "Pt_SjClos1", " 1FatJet_2jets: JetCloseLep[1] p_{T} (GeV); Events", 20, 0, 2000);//done old: 20, 0, 2000
 ...
 m_hSvc.create1D("Eta_SjClos0", " 1FatJet_2jets: Eta(JetCloseLep[0])", 10, -3., 3); //done?
 m_hSvc.create1D("Eta_SjClos1", " 1FatJet_2jets: Eta(JetCloseLep[1])", 10, -3., 3); //done?
 m_hSvc.create1D( "PtZprimeFatJet_W", " 1FatJet: W p_{T} (GeV); Events", 20, 0, 2000);  
 m_hSvc.create1D( "Pt_2SjClos", " 2jets_1FatJet: Jet[1+2] p_{T} (GeV); Events", 20, 0, 2000);
...
//2 fat jets
 m_hSvc.create1D("Mass_2Fatj", " M(Jet_Fat[0]+Jet_Fat[1]) (GeV)", 36, 0, 3600);
 ...
 m_hSvc.create1D("MassGStar_2FatjNSeljL", " GStar Mass (2Fat jets + W) (GeV)", 36, 0, 3600);
 m_hSvc.create1D("Pt2FatJet_FatJet0", " FatJet_0 p_{T} (GeV) ; Events", 20, 0, 2000); //done
 m_hSvc.create1D("dR_closejet", " dR (lepton,closestJet) ; dR (lepton,closestJet)", 10, 0., 3.); //done 
 m_hSvc.create1D("dR_seljet", " dR (lepton,SelJet) ; dR (lepton,SelJet)", 10, 0., 3.); //done
 m_hSvc.create1D("dR_bjet", " dR (lepton,bjet) ; dR (lepton,SelJet)", 10, 0., 3.); //done
}
