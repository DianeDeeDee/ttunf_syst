...
m_hSvc.create1D("MassZprime_2jets", "; Zprime_2jets Mass (GeV) ; Events", 20, 0, 2000);
 ...
 m_hSvc.create1D("Pt1FatJet_2jets", " 1FatJet_2jetsCloseToLep p_{T} (GeV) ; Events", 40, 0, 2000);
 ...
 m_hSvc.create1D( "Pt_1FatJet_2jets_FatJet0", " 2Sjets_1FatJet: FatJet[0] p_{T} (GeV); Events", 40, 0, 2000);//done old: 20, 0, 2000
 m_hSvc.create1D( "Pt_1FatJet_2jets_jetsCloseLep0", " 1FatJet_2jets: JetCloseLep[0] p_{T} (GeV); Events", 40, 0, 2000);//done old: 20, 0, 2000
 m_hSvc.create1D( "Pt_1FatJet_2jets_jetsCloseLep1", " 1FatJet_2jets: JetCloseLep[1] p_{T} (GeV); Events", 40, 0, 2000);//done old: 20, 0, 2000
 ...
 m_hSvc.create1D( "Pt1FatJet2jets_2jets", " 2jets_1FatJet: Jet[1+2] p_{T} (GeV); Events", 40, 0, 2000);
...
//2 fat jets
 ...
 m_hSvc.create1D("PtGStar_2FatJet", " GStar_2FatJet p_{T} (GeV) ; Events", 40, 0, 2000);
  ...
  h->h1D("Eta", "", s)->Fill(l.Eta(), weight);  
   ...
   if(m_electron){
	...
	if (SmaljetsFarLep > 2){
		...
		h->h1D("MassGStar_3jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[3]).M()*1e-3, weight);
	    if (SmaljetsFarLep > 3){
			...
			h->h1D("PtGStar_4jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+e.jet()[sel_jet].mom()+e.electron()[0].mom()).Perp()*1e-3+momNu.Perp()*1e-3, weight);
			h->h1D("Pt4jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]).Perp()*1e-3, weight); 
	    } 
		if (SmaljetsFarLep > 4){
			h->h1D("MassGStar_5jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+SjetsFarLep[4]+e.jet()[sel_jet].mom()+e.electron()[0].mom()).M()*1e-3+momNu.Perp()*1e-3, weight);
			h->h1D("PtGStar_5jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+SjetsFarLep[4]+e.jet()[sel_jet].mom()+e.electron()[0].mom()).Perp()*1e-3+momNu.Perp()*1e-3, weight);
	...
	if (SmaljetsFarLep > 2){
	    ...
	    if (SmaljetsFarLep > 3){
			...
			h->h1D("PtGStar_4jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+e.jet()[sel_jet].mom()+e.muon()[0].mom()).Perp()*1e-3+momNu.Perp()*1e-3, weight);
			h->h1D("Pt4jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]).Perp()*1e-3, weight);
	    }	  
		if (SmaljetsFarLep > 4){
			h->h1D("MassGStar_5jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+SjetsFarLep[4]+e.jet()[sel_jet].mom()+e.muon()[0].mom()).M()*1e-3+momNu.Perp()*1e-3, weight);
			h->h1D("PtGStar_5jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+SjetsFarLep[4]+e.jet()[sel_jet].mom()+e.muon()[0].mom()).Perp()*1e-3+momNu.Perp()*1e-3, weight);
			h->h1D("Pt5jets", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+SjetsFarLep[4]).Perp()*1e-3, weight);
		}	
	}
