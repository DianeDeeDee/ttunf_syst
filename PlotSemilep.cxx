...
//		if (jetsmall < 4  && fatjets < 1) return;	
		...
		if(m_electron){
			...
			if (fatjets == 0 && SmaljetsFarLep > 0){
				if(SmaljetsFarLep == 3){ h->h1D("MassGStar_3SjFarNSeljL", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+e.jet()[sel_jet].mom()+e.electron()[0].mom()+momNu).M()*1e-3, weight);
				...
				else { //std::cout<<"fatjets= "<<fatjets<<" SmaljetsFarLep="<<SmaljetsFarLep<<std::endl;
				...
				if(SmaljetsFarLep > 1){
					...
					h->h1D("Eta_SjFarLepLJet1", "", s)->Fill((SjetsFarLep[1]).Eta(), weight);
                                           ...
                                           h->h1D("MassGStar_2FatjNSeljL", "", s)->Fill((Jet_Fat[0]+Jet_Fat[1]+e.jet()[sel_jet].mom()+e.electron()[0].mom()+momNu).M()*1e-3, weight); 
                                            std::cout<<"Electron: fatjets= "<< fatjets<<std::endl;
                                              }
                                              }    
			}//Electron loop
		...
		///////////////////////Muon steam
			...
			if (fatjets == 0 && SmaljetsFarLep > 0){
				...
				if(SmaljetsFarLep == 3){ h->h1D("MassGStar_3SjFarNSeljL", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[2]+SjetsFarLep[3]+e.jet()[sel_jet].mom()+e.muon()[0].mom()+momNu).M()*1e-3, weight);
				h->h1D("Pt_3SjFar", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[3]).Perp()*1e-3, weight);
				h->h1D("MassT_3SjFar", "", s)->Fill((SjetsFarLep[0]+SjetsFarLep[1]+SjetsFarLep[3]).M()*1e-3, weight);
				}
                                else if (SmaljetsFarLep == 4){
				...
				if(SmaljetsFarLep > 1){
					...
					h->h1D("Eta_SjFarLepLJet1", "", s)->Fill((SjetsFarLep[1]).Eta(), weight);
                         ...
                         else {if (fatjets>2){ h->h1D("MassGStar_2FatjNSeljL", "", s)->Fill((Jet_Fat[0]+Jet_Fat[1]+e.jet()[sel_jet].mom()+e.electron()[0].mom()+momNu).M()*1e-3, weight);
                                   }}
			} //Muon's Loop
		}//e.passReco loop
