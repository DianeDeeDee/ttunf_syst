...
def ReadNonClosureHistograms(dirName):
    ...
    for aFileName in files:
        ...
        for aName,aSystName in SystematicNameDictionary.iteritems():
            ...
            histoSym = ProviderHistoHelpers.SymmetrizeHistoInEta(histo,systematicName+"_sym")
            histoExt = ProviderHistoHelpers.ExtendPtRangeOfHisto(histoSym,systematicName)
            histoExt.SetDirectory(0)
            histos[jetDef][aSystName] = histoExt
