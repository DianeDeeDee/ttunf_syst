...
def ReadFlavourHistograms(dirName):
    ...
    for aFileName in files:
        ...
        for histName in inFile.GetKeyNames():
            baseName = SystematicNameDictionary[histName]
            if "Herwig" in aFileName and not "Herwig" in histName:
                baseName += "_Herwig"
            systematicName = baseName+"_"+jetDef
            ...
            histos[jetDef][baseName] = histoSym
