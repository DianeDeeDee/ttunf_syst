...
./$compareExec $JESsharePath $filePath/${filePrefix}_${1}.config $filePath/${filePrefix}_${2}.config $filePath/${multijetName}.config $algorithms $MCtype 
if test $? -ne 0 ; then
