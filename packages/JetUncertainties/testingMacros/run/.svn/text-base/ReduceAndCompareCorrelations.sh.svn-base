...
#categoriesToReduce="Statistical=3,Modelling=3,Detector=2,Mixed=3" # Best for Final 2012 AllParam
#categoriesToReduce="Statistical=3,Modelling=0,Detector=2,Mixed=4" # Best for Final 2012 StrongerCorrelations
#categoriesToReduce="Statistical=4,Modelling=4,Detector=2,Mixed=0" # Best for Final 2012 WeakerCorrelations
...
fileNameSuffix="WeakerCorrelations" #"StrongerCorrelations" #"AllNuisanceParameters"
