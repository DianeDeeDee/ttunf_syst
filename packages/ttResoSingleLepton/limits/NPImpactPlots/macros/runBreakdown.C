...
void runBreakdown(string inFileName,
    string wsName          = "combined",
    string modelConfigName = "ModelConfig",
    string dataName        = "asimovData_1",
    string poiName         = "SigXsecOverSM_HWW",
    string xmlName         = "config/HSG3_muhat_breakdown.xml",
    string technique       = "add",
    string catecory2eval   = "total",
    double precision       = 0.005,
    double corrCutoff      = 0.0,
    string folder          = "TestCAF7_Ntup26", //Change this to get the right folder name to make in root-files
