...
// double scale_poi           = 3.;   // zoom the impact axis // DEF: 1.
// double scale_theta         = 3.;   // zoom the pull axis // DEF: 1.
double scale_poi           = .8;   // zoom the impact axis // DEF: 1.
double scale_theta         = .8;   // zoom the pull axis // DEF: 1.
...
double showHighImpact      = 0.;
//0.05;  // sigma_comp / sigma_tot threshold
...
//     rename_map[string("ttbar_bb")] = string("t#bar{t}+b#bar{b} normalisation");
//     rename_map[string("LTAGBREAK11")] = string("LightTag1");
//     rename_map[string("ttbar-DataRw-Nottbarpt-HF")] = string("t#bar{t}+HF t#bar{t} p_{T} RW");
//     rename_map[string("ttbar-DataRw-MCgen")] = string("t#bar{t} MCgen RW");
//     rename_map[string("ttbar_cc")] = string("t#bar{t}+c#bar{c} normalisation");
//     rename_map[string("ttbar_MG-PP-HF")] = string("t#bar{t}+HF MG-PP");
//     rename_map[string("LTAGBREAK9")] = string("LightTag2");
//     rename_map[string("ttbar_XS")] = string("t#bar{t} cross section");
//     rename_map[string("ttbar-DataRw-Notoppt-HF")] = string("t#bar{t}+HF top p_{T} RW");
//     rename_map[string("CTAGBREAK5")] = string("CTag1");
//     rename_map[string("BTAGBREAK3")] = string("BTag3");
//     rename_map[string("CTAGBREAK2")] = string("CTag2");
//     rename_map[string("JetModel2")] = string("JES1");
//     rename_map[string("ttbarV_XS")] = string("t#bar{t}+V cross section");
//     rename_map[string("BTAGBREAK4")] = string("BTag2");
//     rename_map[string("BTAGBREAK5")] = string("BTag1");

      rename_map[string("BoostedJES0")] = string("Akt10 JES0 (Gamma-jet)");
      rename_map[string("BoostedJES1")] = string("Akt10 JES1 (dataMC)");
      rename_map[string("BoostedJES2")] = string("Akt10 JES2 (pt2Cut)");
      rename_map[string("BoostedJES3")] = string("Akt10 JES3 (dPhiCut)");
      rename_map[string("BoostedJES4")] = string("Akt10 JES4 (photonPurity)");
      rename_map[string("BoostedJES5")] = string("Akt10 JES5 (PES)");
      rename_map[string("BoostedJES6")] = string("Akt10 JES6 (photonPurity)");
      rename_map[string("BoostedJES7")] = string("Akt10 JES7 (kterm)");
      rename_map[string("BoostedJES8")] = string("Akt10 JES8 (JER)");
      rename_map[string("BoostedJES9")] = string("Akt10 JES9 (akt4insideOutsideLargeR)");
      rename_map[string("BoostedJES10")] = string("Akt10 JES10 (more1smallJetInsideLargeR)");
      rename_map[string("BoostedJES11")] = string("Akt10 JES11 (stats)");
      rename_map[string("BoostedJES12")] = string("Akt10 JES12 (MoverPt)");
      rename_map[string("BoostedJES13")] = string("Akt10 JES13 (Topology)");
      rename_map[string("BoostedJES14")] = string("Akt10 JES14 (Extrapl.)");
      rename_map[string("BoostedJES15")] = string("Akt10 JES15 (NPV)");
      rename_map[string("BoostedJES16")] = string("Akt10 JES16 (#mu)");
      rename_map[string("BoostedJMS")] = string("Akt10 jet m/d12 scale");
      rename_map[string("BoostedJER")] = string("Akt10 jet energy res.");
      rename_map[string("BoostedJMR")] = string("Akt10 jet mass res.");
      rename_map[string("BoostedJESothers")] = string("Akt10 JES (Others)");
      rename_map[string("JES3")] = string("Akt4 JES3 (Modelling1)");
      rename_map[string("JES7")] = string("Akt4 JES7 (Detector1)");
      rename_map[string("JES12")] = string("Akt4 JES12 (EtaInter)");
      rename_map[string("JES18")] = string("Akt4 JES18");
      rename_map[string("JES20")] = string("Akt4 JES20 (PU Rho)");
      rename_map[string("JES21")] = string("Akt4 JES21");
      rename_map[string("JES22")] = string("Akt4 JES22");
      rename_map[string("JESsmall")] = string("Akt4 JES (Others)");
      rename_map[string("JER")] = string("Akt4 jet energy res.");
      rename_map[string("JVF")] = string("Jet vertex fraction");
      rename_map[string("EWS")] = string("t#bar{t} EW Sudakov");
      rename_map[string("ElectronSF")] = string("Electron scale factor");
      rename_map[string("MuonSF")] = string("Muon scale factor");
      rename_map[string("IFSR")] = string("t#bar{t} ISR, FSR");
      rename_map[string("Iqopt3")] = string("W shape, 'iqopt3' ");
      rename_map[string("Ptjmin10")] = string("W shape, ptjmin10' ");
      rename_map[string("MC_Gen")] = string("t#bar{t} Generator dependence");
      rename_map[string("Norm_ttbar")] = string("t#bar{t} normalisation");
      rename_map[string("luminosity")] = string("Luminosity");
      rename_map[string("PS")] = string("t#bar{t} Parton shower");
      rename_map[string("top_mass")] = string("Top mass");
      rename_map[string("PDF")] = string("PDF uncertainty");
      rename_map[string("Whfsf")] = string("W normalisation");
      rename_map[string("btag6")] = string("b-tag EV6");
      rename_map[string("btag7")] = string("b-tag EV7");
      rename_map[string("btag8")] = string("b-tag EV8");
      rename_map[string("btag9")] = string("b-tag EV9");
      rename_map[string("btag10")] = string("b-tag high p_{T}");
      rename_map[string("ctag")] = string("c-tag");
      rename_map[string("mistag")] = string("Mistag");
      rename_map[string("hdamp")] = string("hdamp parameter");
      rename_map[string("Norm_QCDe")] = string("Multi-jets norm, e+jets");
      rename_map[string("Norm_QCDmu")] = string("Multi-jets norm, #mu+jets");

//       rename_map[string("JER")] = string("JetEnerRes");
//       rename_map[string("BoostedJER")] = string("BoostedJER");
//       rename_map[string("BoostedJES0")] = string("BoostedJES0");
//       rename_map[string("BoostedJES1")] = string("BoostedJES1");
//       rename_map[string("BoostedJES13")] = string("BoostedJES13");
//       rename_map[string("BoostedJES14")] = string("BoostedJES14");
//       rename_map[string("BoostedJES15")] = string("BoostedJES15");
//       rename_map[string("BoostedJES16")] = string("BoostedJES16");
//       rename_map[string("BoostedJESothers")] = string("BoostedJESothers");
//       rename_map[string("BoostedJMR")] = string("BoostedJMR");
//       rename_map[string("BoostedJMS")] = string("BoostedJMS");
//       rename_map[string("JES3")] = string("JES3");
//       rename_map[string("JES7")] = string("JES7");
//       rename_map[string("JES12")] = string("JES12");
//       rename_map[string("JES18")] = string("JES18");
//       rename_map[string("JES20")] = string("JES20");
//       rename_map[string("JES21")] = string("JES21");
//       rename_map[string("JES22")] = string("JES22");
//       rename_map[string("JESsmall")] = string("JESsmall");
//       rename_map[string("JVF")] = string("JVFCut");
//       rename_map[string("EWS")] = string("EWS");
//       rename_map[string("ElectronSF")] = string("EleSF");
//       rename_map[string("MuonSF")] = string("MuSF");
//       rename_map[string("IFSR")] = string("IFSR");
//       rename_map[string("Iqopt3")] = string("iqopt3");
//       rename_map[string("Ptjmin10")] = string("ptjmin10");
//       rename_map[string("MC_Gen")] = string("MCGen");
//       rename_map[string("Norm_ttbar")] = string("norm_tt");
//       rename_map[string("luminosity")] = string("luminosity");
//       rename_map[string("PS")] = string("PartonShower");
//       rename_map[string("top_mass")] = string("topmass");
//       rename_map[string("PDF")] = string("PDF");
//       rename_map[string("Whfsf")] = string("Whfsf");
//       rename_map[string("btag6")] = string("Btag6");
//       rename_map[string("btag7")] = string("Btag7");
//       rename_map[string("btag8")] = string("Btag8");
//       rename_map[string("btag9")] = string("Btag9");
//       rename_map[string("btag10")] = string("Btag10");
//       rename_map[string("ctag")] = string("BtagC");
//       rename_map[string("mistag")] = string("BtagL");
//       rename_map[string("hdamp")] = string("hdamp");
//       rename_map[string("Norm_QCDe")] = string("norm_QCDe");
//       rename_map[string("Norm_QCDmu")] = string("norm_QCDmu");
    ...
    if (drawParamNames) pad1->SetLeftMargin(0.22);
    ...
    ATLASLabel(labelPosX+0.1,labelPosY,"Internal",1);

    TLatex p;
    p.SetNDC();
    p.SetTextFont(40);
    p.DrawLatex(labelPosX-0.076,labelPosY-0.04,labelTxt.c_str());
    ...
    t2.SetTextSize(0.03);
    t2.SetNDC();
    //t2.DrawLatex(channelPosX, channelPosY-0.07, ("m_{H}="+mass+" GeV").c_str()); //TV commented out!

    stringstream saveName;
    //saveName << cardName << "_pulls_" << mass;
    saveName << cardName << "_pulls";
...
void drawPlot_pulls2(string cardName, string mass, TCanvas* c1, TPad* pad1, TPad* pad2) {
    ...
    while (1) {
        ...
        string label;
        idFile >> label;
        if (label.find("alpha")!=std::string::npos)
          label = label.replace(0,6,"");
        else
          label = TString(label).ReplaceAll("_"," ");
        if(rename_map.count(label))
    ...
    std::cout << "sigma_tot_hi " << sigma_tot_hi << std::endl;
    std::cout << "sigma_tot_lo " << sigma_tot_lo << std::endl;
    ...
    if (rankNuis) {
        for (int i = 0; i < nrNuis-1; i++) {
            for (int j = 0; j < nrNuis-1-i; j++) {
                //if (poi_nom_up[j]+poi_nom_down[j] > poi_nom_up[j+1]+poi_nom_down[j+1]) { // to rank with prefit impact
    ...
    h->SetLabelSize(labelSize>0.04?0.04:labelSize,"Y");
	...
	std::cout << "NP name " << drawParamNames << std::endl;
    }
    h2->SetStats(0);
    ...
    //TGaxis *axis_theta = new TGaxis(border_lo, -offset, border_hi, -offset, -sigma_tot_lo / (scale_theta*int(sigma_tot_lo)), sigma_tot_hi / (scale_theta*int(sigma_tot_hi)), 510, "+R");
    ...
    if (drawPrefitImpactBand) {
        leg->AddEntry(gr_poi_nom, "Pre-fit Impact on #mu", "f");
        if (nrNuis_ol > 0) leg->AddEntry(gr_poi_nom_ol, "Alt Prefit Impact on #mu", "f");
    }
    if (drawPostfitImpactBand) {
        leg->AddEntry(gr_poi, "Post-fit Impact on #mu", "f");
