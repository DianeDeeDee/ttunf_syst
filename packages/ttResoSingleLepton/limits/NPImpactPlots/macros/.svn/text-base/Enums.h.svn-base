...
enum WjetsFakeSysts {WjetsFakeSysts_SysFakeStat_10_15=0, WjetsFakeSysts_SysFakeStat_15_20, WjetsFakeSysts_SysFakeStat_20_25, WjetsFakeSysts_SysFakeStat_GT25, 
		     ...
		     WjetsFakeSysts_SysFakeOther_GT10,
		     n_WjetsFakeSysts};
...
static const unsigned int nElecIDSystsBins = 12; //Used only if !electronSystsCommonScheme
static unsigned int elecIDBinsList[] ={90020, 90025, 100007, 100008, 100012, 100013, 100017, 100018, 100027, 100028, 100032, 100033}; //Used only if !electronSystsCommonScheme
static const unsigned int nElecRecoSystsBins = 21; //Used only if !electronSystsCommonScheme
static unsigned int elecRecoBinsList[] ={90020, 90025, 100000, 100013, 100025, 100037, 100049, 100073, 100085, 100097, 100109, 100121, 100133, 100145, 100157, 100169, 100181, 100205, 100217, 100229, 100241}; //Used only if !electronSystsCommonScheme
