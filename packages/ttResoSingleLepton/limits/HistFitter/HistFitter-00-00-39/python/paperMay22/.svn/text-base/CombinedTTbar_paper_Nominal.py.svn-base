...
if not (noSyst or excludeSyst == "Whfsf"):
   WjetsSample.addSystematic(Systematic("Whfsf","Nom","WhfsfHigh","WhfsfLow","tree","overallSys"))
if not (noSyst or excludeSyst == "Iqopt3"):
   WjetsSample.addSystematic(Systematic("Iqopt3","Nom","Iqopt3High","Iqopt3Low","tree","overallSys"))
if not (noSyst or excludeSyst == "Ptjmin10"):
   WjetsSample.addSystematic(Systematic("Ptjmin10","Nom","Ptjmin10High","Ptjmin10Low","tree","overallSys"))
