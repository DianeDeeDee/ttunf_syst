#ifndef TTBarLeptonJetsBuilder_chi2_H
#define TTBarLeptonJetsBuilder_chi2_H
...
class TTBarLeptonJetsBuilder_chi2{
 public:
  TTBarLeptonJetsBuilder_chi2(std::string units="GeV");
  virtual ~TTBarLeptonJetsBuilder_chi2();
 ...
 private:
  TTBarLeptonJetsBuilder_chi2(const TTBarLeptonJetsBuilder_chi2&);
  TTBarLeptonJetsBuilder_chi2& operator=(const TTBarLeptonJetsBuilder_chi2&);
