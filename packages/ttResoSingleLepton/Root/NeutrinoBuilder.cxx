...
//_________________________________________________________________________________________________
NeutrinoBuilder::~NeutrinoBuilder(){
  if(m_debug>0) std::cout << "in destructor " << std::endl;
}

//_________________________________________________________________________________________________                                                         
NeutrinoBuilder::NeutrinoBuilder(const NeutrinoBuilder& other) {                                                                                     
  m_debug = other.m_debug;
}

//_________________________________________________________________________________________________                                                         
NeutrinoBuilder& NeutrinoBuilder::operator=(const NeutrinoBuilder& other) {                                                                           
  if(this != &other) {
    m_debug = other.m_debug;
  }
  return *this;
...
//_________________________________________________________________________________________________
double NeutrinoBuilder::fitAlpha(const TLorentzVector* L, const Double_t met, const Double_t metphi){
...
//_________________________________________________________________________________________________
std::vector<TLorentzVector*> NeutrinoBuilder::candidatesFromWMass_Scaling(const TLorentzVector* L, const TLorentzVector* MET){
return this->candidatesFromWMass_Scaling(L, MET->Px(), MET->Py());
}

// In case of negative discriminant, decrease the MET
//_________________________________________________________________________________________________
std::vector<TLorentzVector*> NeutrinoBuilder::candidatesFromWMass_Scaling(const TLorentzVector* L, const double met_etx, const double met_ety){
...
// In case of negative discriminant, decrease the MET
//_________________________________________________________________________________________________
bool NeutrinoBuilder::candidatesFromWMass_Scaling(const TLorentzVector* L, const double met_etx, const double met_ety, std::vector<TLorentzVector*>& NC){
...
//_________________________________________________________________________________________________
std::vector<TLorentzVector*> NeutrinoBuilder::candidatesFromWMass_RealPart(const TLorentzVector* L, const TLorentzVector* MET, const bool useSmallestPz){
   return this->candidatesFromWMass_RealPart(L, MET->Pt(), MET->Phi(), useSmallestPz);
}
// In case of negative discriminant, use the real part
//_________________________________________________________________________________________________
std::vector<TLorentzVector*> NeutrinoBuilder::candidatesFromWMass_RealPart(const TLorentzVector* L, Double_t met, Double_t metphi, const bool useSmallestPz){
