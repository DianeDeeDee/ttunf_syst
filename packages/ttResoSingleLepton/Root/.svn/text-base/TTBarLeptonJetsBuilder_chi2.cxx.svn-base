...
TTBarLeptonJetsBuilder_chi2::TTBarLeptonJetsBuilder_chi2(std::string units){
  m_debug = 0;
  m_WReco = ROTATION;
  if     (units=="MeV")m_Units = 1000.;
  else if(units=="GeV")m_Units = 1.;
  else std::cerr << "WARNING in TTBarLeptonJetsBuilder_chi2: units different from GeV or MeV" << std::endl;
  m_UsePtDiff = PTDIFF;
  m_Btag = AFFECTBTAG;
  m_RunMode = RUNDEFAULT;
  m_NeutrinoBuilder = new NeutrinoBuilder(units);
  Init(DATA2012SUMMER2013);
  res_chi2All  = -1.;
  res_chi2WH   = -1.;
  res_chi2TopH = -1.;
  res_chi2TopL = -1.;
...
//_________________________________________________________________________________________________
TTBarLeptonJetsBuilder_chi2::~TTBarLeptonJetsBuilder_chi2(){
  if(m_debug>0) std::cout << "in destructor " << std::endl;
  if (m_NeutrinoBuilder) delete m_NeutrinoBuilder;
}

//_________________________________________________________________________________________________
void TTBarLeptonJetsBuilder_chi2::Init(Chi2Version version, double highJetMass) {
  ...
  switch (version){
	...
	break;
     default:
  	std::cerr << "TTBarLeptonJetsBuilder_chi2::Init   chi2 is not defined!!" << std::endl;
	break;
  }
  return;
}
...
//_________________________________________________________________________________________________
void TTBarLeptonJetsBuilder_chi2::Reset(){
  res_chi2All  = -1.;
  res_chi2WH   = -1.;
  res_chi2TopH = -1.;
  res_chi2TopL = -1.;
...
//_________________________________________________________________________________________________
std::vector<TLorentzVector*> TTBarLeptonJetsBuilder_chi2::GetNeutrinos(TLorentzVector* L, TLorentzVector*MET){
...
//_________________________________________________________________________________________________
bool TTBarLeptonJetsBuilder_chi2::findMinChiSquare_HMelseLM(TLorentzVector* L, const std::vector<TLorentzVector*>* jetVector,  const std::vector<bool>* isJetBtagged, TLorentzVector* MET, int& i_q1_W, int& i_q2_W, int& i_b_had, int& i_b_lep, int& ign1, double& chi2ming1, double& chi2ming1H, double& chi2ming1L){
  if(m_debug>0) std::cout << "entering TTBarLeptonJetsBuilder_chi2::findMinChiSquare_HMelseLM()" << std::endl;
  bool status = false;
...
//_________________________________________________________________________________________________
bool TTBarLeptonJetsBuilder_chi2::findMinChiSquare_LMelseHM(TLorentzVector* L, const std::vector<TLorentzVector*>* jetVector,  const std::vector<bool>* isJetBtagged, TLorentzVector* MET, int& i_q1_W, int& i_q2_W, int& i_b_had, int& i_b_lep, int& ign1, double& chi2ming1, double& chi2ming1H, double& chi2ming1L){
  if(m_debug>0) std::cout << "entering TTBarLeptonJetsBuilder_chi2::findMinChiSquare_LMelseHM()" << std::endl;
  bool status = false;
...
//_________________________________________________________________________________________________
bool TTBarLeptonJetsBuilder_chi2::findMinChiSquare_AllRanges(TLorentzVector* L, const std::vector<TLorentzVector*>* jetVector,  const std::vector<bool>* isJetBtagged, TLorentzVector* MET, int& i_q1_W, int& i_q2_W, int& i_b_had, int& i_b_lep, int& ign1, double& chi2ming1, double& chi2ming1H, double& chi2ming1L){
  if(m_debug>0) std::cout << "entering TTBarLeptonJetsBuilder_chi2::findMinChiSquare_AllRanges()" << std::endl;
  bool status = false;
  float massMax = 0.;
...
//_________________________________________________________________________________________________
bool TTBarLeptonJetsBuilder_chi2::findMinChiSquare(TLorentzVector* L, const std::vector<TLorentzVector*>* jetVector,  const std::vector<bool>* isJetBtagged, TLorentzVector* MET, int& i_q1_W, int& i_q2_W, int& i_b_had, int& i_b_lep, int& ign1, double& chi2ming1, double& chi2ming1H, double& chi2ming1L){
  if(m_debug>0) std::cout << "entering TTBarLeptonJetsBuilder_chi2::findMinChiSquare()" << std::endl;
  //_________________________________________________________________________________________________
  i_q1_W=-1;
  i_q2_W=-1;
  i_b_had=-1;
  ...
  if (L == NULL) {
  	std::cerr << "ERROR : TTBarLeptonJetsBuilder_chi2::findMinChiSquare: Lepton is NULL" << std::endl;
  	return false;
  }
		 ...
		 if(passBtag){
			...
			if(n_bjets==0){
				...
				if(isJetBtagged->at(k)){//b-jet on the hadronic side
					...
					std::cerr << "<!> In TTBarLeptonJetsBuilder_chi2::findMinChiSquare : cannot find the corresponding category." << std::endl;
				}
			}else if(n_bjets>=2){
				if(isJetBtagged->at(k)){//b-jet on the hadronic side
...
//_________________________________________________________________________________________________
bool TTBarLeptonJetsBuilder_chi2::findMinChiSquare_HighMass(TLorentzVector* L, const std::vector<TLorentzVector*>* jetVector,  const std::vector<bool>* isJetBtagged, TLorentzVector* MET, int& i_q1_W, int& i_q2_W, int& i_b_lep, int& ign1, double& chi2ming1, double&
chi2ming1H, double& chi2ming1L){
  if(m_debug>0) std::cout << "entering TTBarLeptonJetsBuilder_chi2::findMinChiSquare_HighMass()" << std::endl;
  //_________________________________________________________________________________________________
  i_q1_W=-1;
  i_q2_W=-1;
  i_b_lep=-1;
...
//_________________________________________________________________________________________________
bool TTBarLeptonJetsBuilder_chi2::findMinChiSquare_VeryHighMass(TLorentzVector* L, const std::vector<TLorentzVector*>* jetVector,  const std::vector<bool>* isJetBtagged, TLorentzVector* MET, int& i_q2_W, int& i_b_lep, int& ign1, double& chi2ming1, double& chi2ming1H, double& chi2ming1L){
  if(m_debug>0) std::cout << "entering TTBarLeptonJetsBuilder_chi2::findMinChiSquare_VeryHighMass() " << std::endl;
  //_________________________________________________________________________________________________
  i_q2_W=-1;
  i_b_lep=-1;
  ign1=-1;
