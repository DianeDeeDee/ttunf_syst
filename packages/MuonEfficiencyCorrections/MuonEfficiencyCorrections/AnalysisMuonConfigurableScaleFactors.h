...
public:
    ...
    double scaleFactor(int charge, const TLorentzVector & tlv, const std::pair<int,int>& bin) const;
    ...
    double scaleFactorUncertainty(int charge, const TLorentzVector & tlv, const std::pair<int,int>& bin) const;
    ...
    double scaleFactorSystematicUncertainty(int charge, const TLorentzVector & tlv, const std::pair<int,int>& bin) const;
   ...
   //function to generate a replica of SFs to treat statistical error
    ...
    double scaleFactorReplica(int charge, const TLorentzVector & tlv, int nr, const std::pair<int,int>& bin) const;
...
// pt-eta-phi map of the efficiency scale factors //
    ...
    std::string ReadZippedEffiFile(TString fname) const;
    EtaPhiBinning m_EPbin;
    fineEtaPhiBinning m_fEPbin;
    bool m_is_finely_binned;
 };
