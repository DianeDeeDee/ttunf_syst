...
double ele_ID_SF(double eta, double ET)
{
    ...
    const double etabins[18] = {-2.47,-2.37,-2.01,-1.81,-1.37,
							    ...
							    1.52,1.81,2.01,2.37};
    const double ETbins[6] = {20.,25.,30.,35.,40.,45.}; // lower edges of et bins

	const double SFmatrix[6][18] = {{0.891, 0.888, 0.922, 0.923, 0.997, 0.924, 0.897, 0.884, 0.899, 
                                                                        0.877, 0.877, 0.902, 0.925, 0.962, 0.939, 0.919, 0.882, 0.912},
                                                                        {0.972, 0.964, 1.007, 1.016, 1.071, 1.007, 0.967, 0.957, 0.979, 
...
double ele_ID_SF_err(double eta, double ET)
{
	...
	const double errmatrix[6][18] = {{0.044, 0.036, 0.043, 0.034, 0.036, 0.034, 0.034, 0.034, 0.037, 
	                                                                 0.035, 0.034, 0.035, 0.035, 0.039, 0.035, 0.040, 0.035, 0.039},
	                                                                 {0.038, 0.029, 0.037, 0.027, 0.029, 0.027, 0.027, 0.026, 0.030,
