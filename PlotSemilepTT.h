#ifndef PLOTSEMILEPTT_H
#define PLOTSEMILEPTT_H
...
class PlotSemilepTT : public Plot {
  public:
    PlotSemilepTT(const std::string &filename, int mode, const std::vector<std::string> &systs);
    virtual ~PlotSemilepTT();
