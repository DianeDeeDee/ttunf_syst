...
m_hSvc.create1D("MassZprime_2jets", "; Zprime_2jets Mass (GeV) ; Events", 20, 0, 2000);
  ...
  m_hSvc.create1D("MassGStar_1Fatj2SjClosNSeljL", "; GStar Mass (2Sjets + 1Fat jets + W) (GeV)", 20, 0, 3600);

 m_hSvc.create1D("Pt_1Fatj2SjClos", " 1FatJet_2jetsCloseToLep p_{T} (GeV) ; Events", 20, 0, 2000);
                 
  m_hSvc.create1D("PtGStar_1Fatj2SjClosNSeljL", "; GStar p_{T} (2Sjets + 1Fat jets + W) (GeV) ; Events", 20, 0, 1000);

 m_hSvc.create1D("Mass_1Fatj2SjClos", " M(Jet_Fat[0]+SjetsCloseLep[0]+SjetsCloseLep[1]) (GeV)", 20, 0, 3600);
 ...
 m_hSvc.create1D( "Pt_SjClos0", " 1FatJet_2jets: JetCloseLep[0] p_{T} (GeV); Events", 20, 0, 1000);//done old: 20, 0, 2000
 m_hSvc.create1D( "Pt_SjClos1", " 1FatJet_2jets: JetCloseLep[1] p_{T} (GeV); Events", 20, 0, 1000);//done old: 20, 0, 2000
...
// if (jetsmall < 5  && fatjets < 1) return;
 if (fatjets > 1) std::cout<<"fatjets= "<<fatjets<<"jetsmall= "<<jetsmall<<std::endl;
