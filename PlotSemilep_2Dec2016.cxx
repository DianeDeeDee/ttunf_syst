...
//fatjers00++;
///*h->h1D("PtLj_00", "", s)->Fill((e.largeJet()[k].mom().Perp())*1e-3, weight);
//h->h1D("Mass_00", "", s)->Fill((e.largeJet()[k].mom().M())*1e-3, weight);
//h->h1D("Dr_00", "", s)->Fill(e.jet()[sel_jet].mom().DeltaR(e.largeJet()[k].mom()), weight);
//h->h1D("DPhi_00", "", s)->Fill(e.largeJet()[k].mom().DeltaPhi(l), weight);
//h->h1D("Eta_00", "", s)->Fill(e.largeJet()[k].mom().Eta(),weight);*/
//}
//h->h1D("NLargeJets_00", "", s)->Fill(fatjers00, weight);
...
//      passD12 = e.largeJet()[k].split12() > 20e3;//40e3;//true
  ...
  for (int k = 0; k < e.jet().size(); ++k) {
  	//std::cout<<"375"<<std::endl;
         double tdr = e.jet()[k].mom().DeltaR(l);
         //std::cout<<"377 tdr="<<tdr<<std::endl;
         double tdr2 = e.jet()[k].mom().DeltaR(ljet);
          //std::cout<<"379 tdr2="<<tdr2<<std::endl;
         if(tdr > 1.5){
         ...
         if(tdr > 1.5 && tdr2 > 1.5){
         //	std::cout<<"392 tdr="<<tdr<<" tdr2= "<<tdr2<<std::endl;
             SjetsFarLepLJ = k;
...
//	h->h1D("largeJetPt", "", s)->Fill(Jet_Fat[0].Perp()*1e-3, weight);
//h->h1D("Mass_0", "", s)->Fill((Jet_Fat[0].M())*1e-3, weight);
//h->h1D("Dr_0", "", s)->Fill(e.jet()[sel_jet].mom().DeltaR(Jet_Fat[0]), weight);
//h->h1D("DPhi_0", "", s)->Fill(Jet_Fat[0].DeltaPhi(l), weight);
//h->h1D("Eta_0", "", s)->Fill(Jet_Fat[0].Eta(),weight);
//h->h1D("largeJetPt_0", "", s)->Fill(Jet_Fat[0].Perp()*1e-3, weight);
////h->h1D("D12_0", "", s)->Fill((Jet_Fat[0].split12())*1e-3, weight);
//}
/*
if(fatjets>1){
h->h1D("Mass_00", "", s)->Fill((Jet_Fat[1].M())*1e-3, weight);
h->h1D("Dr_00", "", s)->Fill(e.jet()[sel_jet].mom().DeltaR(Jet_Fat[1]), weight);
h->h1D("DPhi_00", "", s)->Fill(Jet_Fat[1].DeltaPhi(l), weight);
h->h1D("Eta_00", "", s)->Fill(Jet_Fat[1].Eta(),weight);
//h->h1D("D12_00", "", s)->Fill((Jet_Fat[1].split12())*1e-3, weight);
h->h1D("largeJetPt_00", "", s)->Fill(Jet_Fat[1].Perp()*1e-3, weight);
}*/
//
//if(fatjets>2){
//h->h1D("Mass", "", s)->Fill((Jet_Fat[2].M())*1e-3, weight);
//h->h1D("Dr", "", s)->Fill(e.jet()[sel_jet].mom().DeltaR(Jet_Fat[2]), weight);
//h->h1D("DPhi", "", s)->Fill(Jet_Fat[2].DeltaPhi(l), weight);
//h->h1D("Eta0", "", s)->Fill(Jet_Fat[2].Eta(),weight);
//h->h1D("largeJetPt0", "", s)->Fill(Jet_Fat[2].Perp()*1e-3, weight);
////h->h1D("D120", "", s)->Fill((Jet_Fat[2].split12())*1e-3, weight);
//}
...
//		h->h1D("NSjetsFarLepLJet_FatJet1", "", s)->Fill(SmaljetsFarLep, weight);
//		}
		if(fatjets > 0) {
                        h->h1D("largeJetM", "", s)->Fill((Jet_Fat[0]).M()*1e-3, weight);
                        h->h1D("largeJetPt", "", s)->Fill(Jet_Fat[0].Perp()*1e-3, weight);
			...
			h->h1D("NSmaljetsFarLepLJet_FatJet2", "", s)->Fill(SmaljetsFarLep, weight);
...
//		h->h1D("NSjetsFarLepLJet_chan_FatJet0", "", s)->Fill(SmaljetsFarLep, weight);
