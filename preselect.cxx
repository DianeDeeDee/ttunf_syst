...
int main(int argc, char **argv) {
 ...
 // rr.doParticleLevelSelection((bool) doParticle);
  ...
  Correction *ejetOR = 0;
   Correction *ejetORLoose = 0;//Line for New Test
  if (doCorr) {
    ...
    vecCorr.push_back(new Corrections::ElJetORLoose); //?? New
   /* if (mode <= 3) ejetOR = new Corrections::ElJetOR;*/
    
     ejetOR = new Corrections::ElJetOR;
    ejetORLoose = new Corrections::ElJetORLoose;//Line for New Test
  ...
  if (!isData && syst && mode <= 3) {
    ...
    systNames.push_back("EffectiveNP_Statistical1Low");
    systNames.push_back("EffectiveNP_Statistical1High");
    systNames.push_back("EffectiveNP_Statistical2Low");
    systNames.push_back("EffectiveNP_Statistical2High");
    systNames.push_back("EffectiveNP_Statistical3Low");
    systNames.push_back("EffectiveNP_Statistical3High");
    systNames.push_back("EffectiveNP_Statistical4Low");
    systNames.push_back("EffectiveNP_Statistical4High");
    systNames.push_back("EffectiveNP_Modelling1Low");
    systNames.push_back("EffectiveNP_Modelling1High");
    systNames.push_back("EffectiveNP_Modelling2Low");
    systNames.push_back("EffectiveNP_Modelling2High");
    systNames.push_back("EffectiveNP_Modelling3Low");
    systNames.push_back("EffectiveNP_Modelling3High");
    systNames.push_back("EffectiveNP_Modelling4Low");
    systNames.push_back("EffectiveNP_Modelling4High");
    systNames.push_back("EffectiveNP_Detector1Low");
    systNames.push_back("EffectiveNP_Detector1High");
    systNames.push_back("EffectiveNP_Detector2Low");
    systNames.push_back("EffectiveNP_Detector2High");
    systNames.push_back("EffectiveNP_Detector3Low");
    systNames.push_back("EffectiveNP_Detector3High");
    systNames.push_back("EffectiveNP_Mixed1Low");
    systNames.push_back("EffectiveNP_Mixed1High");
    systNames.push_back("EffectiveNP_Mixed2Low");
    systNames.push_back("EffectiveNP_Mixed2High");
    systNames.push_back("EffectiveNP_Mixed3Low");
    systNames.push_back("EffectiveNP_Mixed3High");
    systNames.push_back("EffectiveNP_Mixed4Low");
    systNames.push_back("EffectiveNP_Mixed4High");
    systNames.push_back("EtaIntercalibration_ModellingLow");
    systNames.push_back("EtaIntercalibration_ModellingHigh");
    systNames.push_back("EtaIntercalibration_TotalStatLow");
    systNames.push_back("EtaIntercalibration_TotalStatHigh");
    systNames.push_back("Pileup_OffsetMuLow");
    systNames.push_back("Pileup_OffsetMuHigh");
    systNames.push_back("Pileup_OffsetNPVLow");
    systNames.push_back("Pileup_OffsetNPVHigh");
    systNames.push_back("Pileup_PtTerm_MuLow");
    systNames.push_back("Pileup_PtTerm_MuHigh");
	systNames.push_back("Pileup_PtTerm_NPVLow");
	systNames.push_back("Pileup_PtTerm_NPVHigh");
	systNames.push_back("Pileup_RhoTopologyLow");
	systNames.push_back("Pileup_RhoTopologyHigh");
	systNames.push_back("RelativeNonClosure_MCTYPELow");
	systNames.push_back("RelativeNonClosure_MCTYPEHigh");
	systNames.push_back("SingleParticle_HighPtLow");
	systNames.push_back("SingleParticle_HighPtHigh");
//    systNames.push_back("RelativeNonClosure_Pythia8Low");
//    systNames.push_back("RelativeNonClosure_Pythia8High");
  }
...
//New test
 e.clear();
      ...
      sel.rho() = e.rho();
       ...
       if(!isData && syst)  e.setupSystVariation(systNames[s]); //comment??
        if (ejetORLoose) {
...
//End New test 11 aout 2016
  ...
  metRecalc = 0;
  ejetOR = 0;
   ejetORLoose = 0; //line for New Test
  delete se;
  if (sep) delete sep;
